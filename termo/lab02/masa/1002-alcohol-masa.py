...
t1 = np.genfromtxt("datos-alcohol-100.txt", usecols= 0)
temp1 = np.genfromtxt("datos-alcohol-100.txt", usecols= 1)

"""datos para una masa de 150 g """
t2= np.genfromtxt("datos-alcohol-150.txt", usecols= 0)
temp2 = np.genfromtxt("datos-alcohol-150.txt", usecols= 1)

"""datos para una masa de 200 g """
t3 = np.genfromtxt("datos-alcohol-200.txt", usecols= 0)
temp3 = np.genfromtxt("datos-alcohol-200.txt", usecols= 1)
