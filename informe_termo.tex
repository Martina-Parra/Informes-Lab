...
%========Introducción
\section{Introdución}
      En el presente documento contiene series de datos obtenidos en la simulacion de laboratorio.
      Los pricncipales objetivos de este proyecto son:
...
\begin{figure}[h]
    \begin{subfigure}
     \includegraphics[width=10cm, height=6cm]{grafico1.pdf}
       \caption{Mi figura}
       \label{fig:ejemplo}
  \end{subfigure}
\end{figure}
