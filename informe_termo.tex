...
\begin{enumerate}
    ...
    \item Para la segunda simulación, se trabajó con un número de partículas pesadas n = 50, y una
    temperatura inicial de 300K. La presión estaba oscilando entre 5,4atm y 6,3atm
    aproximadamente,  después la hicimos constante en alguno de estos valores, donde el recipiente inicial fue de 10nm. Luego, 
